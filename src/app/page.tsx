...
function App() {
  ...
  const navItems: NavItem[] = [
    ...
    { id: "pricing", label: "Pricing", icon: <Wallet size={18} /> },
  ...
  return (
    <div className={`${theme === "dark" ? "dark" : ""} min-h-screen transition-colors duration-300`}>
      <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white min-h-screen transition-colors duration-300">
        ...
        {/* Navigation */}
        <header className="fixed top-0 w-full z-40 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg transition-colors duration-300">
        ...
        <main className="pt-20">
          ...
          {/*PRicing */}
          <section ref={sectionRefs.pricing} id="pricing" className="min-h-screen bg-gray-50 py-12 font-sans">
